import{_ as t,r as e,o,c as p,a as n,d as s,b as c,e as i}from"./app--s5p6FgW.js";const l={},u=n("h1",{id:"python-猜拳遊戲",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python-猜拳遊戲","aria-hidden":"true"},"#"),s(" Python 猜拳遊戲")],-1),r={href:"https://replit.com/@k1319900103/Start#game.py",target:"_blank",rel:"noopener noreferrer"},k=i(`<div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> random
