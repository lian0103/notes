import{_ as e,r as o,o as l,c as r,a as s,b as p,w as t,d as n,f as c}from"./app-QUezCbp3.js";const i={},u=s("h1",{id:"vue3-slot-card組件實作",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#vue3-slot-card組件實作","aria-hidden":"true"},"#"),n(" vue3 slot & Card組件實作")],-1),d={class:"table-of-contents"},k=c(`<h2 id="畫面需求" tabindex="-1"><a class="header-anchor" href="#畫面需求" aria-hidden="true">#</a> 畫面需求</h2><p>1.圖片寬高比16:9</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">.img</span> <span class="token punctuation">{</span>
